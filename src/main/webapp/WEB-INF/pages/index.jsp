...
<div class="container">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul id="groupList" class="nav navbar-nav">
                    ...
                    <li>
                        <button type="button" id="saveToCSV" class="btn btn-default navbar-btn">Save contacts to CSV
                        </button>
                    </li>
                    <li>
                        <button type="button" id="loadFromCSV" class="btn btn-default navbar-btn">Load contacts from
                            CSV
                        </button>
                    </li>
                    <li class="dropdown">
    ...
    <nav aria-label="Page navigation">
        <ul class="pagination">
            ...
            <c:if test="${patternPages ne null}">
                <c:forEach var="i" begin="1" end="${patternPages}">
                    <li><a href="/search?page=<c:out value="${i - 1}"/>"><c:out value="${i}"/></a></li>
                </c:forEach>
            </c:if>
        </ul>
    </nav>
...
<script>
    ...
    $('#saveToCSV').click(function () {
        window.location.href = '/saveToCSV';
    });

    $('#loadFromCSV').click(function () {
        window.location.href = '/loadFromCSVpage';
    });
